...
const SelectOption: FC<{ defaultValue: any, values: string[] | number[] | undefined | Color[], handleClick: (value: any) => void, placeholder?: string }> = ({ defaultValue, values, handleClick, placeholder }) => {
