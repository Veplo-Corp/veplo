...
const SelectFilterOption: FC<{ defaultValue?: number | string, values: string[] | number[], handleClick: (value: any) => void, placeholder?: string }> = ({ defaultValue, values, handleClick, placeholder }) => {
