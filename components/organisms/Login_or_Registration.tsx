    ...
    return (
        ...
        <>
            <div className='flex justify-between w-full'>
                <form className="md:p-3 space-y-4 w-fit md:w-1/2" onSubmit={handleSubmitForm}>
                ...
                sm:text-sm placeholder-black" placeholder="email" />
                    ...
                    {type !== 'reset_password' && <div>
                        <div className="mt-1 flex rounded-sm md:w-96">
                            ...
                            <input
                                ...
                                autoComplete={'on'}
                                type={showPassword ? 'text' : 'password'} name="password" id="password" className="block md:w-fit flex-1 border-2 border-r-0	 p-2 py-3 border-gray-900
                                    focus:outline-none
                    ...
                    {type === 'reset_password' && <div className='w-full flex justify-end pt-2 md:pt-1 md:w-96' onClick={() => resetPassword(email)}>
