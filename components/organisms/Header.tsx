...
const Header = () => {
    ...
    return (
        ...
        // <div className="sm:px-8 fixed z-10 top-4"> 
        //         <a href="#">
        //             <span className="sr-only">Your Company</span>
        //             <img className="h-8 w-20 sm:h-10" src="https://tailwindui.com/img/logos/mark.svg?color=indigo&shade=600" alt="" />
        //         </a>
        //     </div>
            ...
            <div className="mx-auto max-w-full border-b-2 border-gray-100 ">
                <div className=" py-3 lg:justify-start lg:space-x-10">
                    <div className='flex items-center justify-between '>
                        <div className="lg:pl-8 w-96 hidden lg:flex"> {/* lg:w-0 lg:flex-1 */}
                            <Link href="/home">
                                <a className="font-black text-3xl italic text-black-900">DINTORNI</a>

                            </Link>
                        </div>
                        <div className="-my-2 -mr-2 lg:hidden">
                            <button type="button" className="inline-flex items-center justify-center rounded-md bg-white p-2 px-4 text-gray-400 hover:bg-gray-100 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500" aria-expanded="false">
                        ...
                        <nav className=" justify-center w-full hidden lg:flex  "> {/* pr-80 */}
                            <a className={` ${router.genere == "uomo" && !showCategory ? "underline underline-offset-4" : ""} cursor-pointer text-base font-medium text-gray-900 hover:text-gray-900 mr-8 py-0.5`} onClick={handleShowCategory}>Uomo</a>
                            <a className={` ${router.genere == "donna" && !showCategory ? "underline underline-offset-4" : ""} cursor-pointer text-base font-medium text-gray-900 hover:text-gray-900 mr-8 py-0.5`} onClick={handleShowCategory}>Donna</a>
                ...
                {showCategory && <div className='h-96 border-b-2 border-gray-100'>
                </div>}
            </div>
