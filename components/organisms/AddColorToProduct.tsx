...
const AddColorToProduct: FC<{ category: string, deleteCard?: any, confirmCard: (variation: VariationCard) => void, colors: Color[] }> = ({ category, deleteCard, confirmCard, colors }) => {
