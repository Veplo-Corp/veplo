...
const Gradient_Component_home: FC<{ children: any }> = ({ children }) => {
    return (
        <div
            className={`w-full min-h-96 px-4`}
            style={{
                background: 'linear-gradient(180deg, rgba(192,133,228,0.9206276260504201) 0%, rgba(192,133,228,0.36320465686274506) 60%, rgba(192,133,228,0) 100%)'
