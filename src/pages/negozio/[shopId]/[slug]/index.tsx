                ...
                <Box className='w-fit'>
                    ...
                    <Box py={0.5} display='flex' className='justify-between	'>
                        ...
                        <Box display='flex' className='my-auto'>
                            ...
                            <a href={`https://wa.me/+39${shop.phone}?text=ciao, ero su Dintorni.it e stavo visitando il tuo negozio ${shop.name}. Avrei bisogno di una informazione`} target="_blank" >
