...
return (
    <Desktop_Layout>
        ...
        <div className="grid grid-cols-1 pt-4 md:grid-cols-2 lg:grid-cols-3 gap-x-10 gap-y-4 w-full m-auto justify-items-center	">
            {shops.map((shop) => {
                return (
                    <Box_Shop scale={'scale(0.99)'} key={Math.random()} eventHandler={toStore} shop={shop} width={420} height={270} />
