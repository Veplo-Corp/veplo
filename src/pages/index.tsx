...
const Home: NextPage = () => {
  ...
  return (
    <Shop_not_Allowed>
      <PostMeta title={'Veplo'} subtitle={"Veplo è il sito dove trovare tutti i negozi di vestiti della tua città online"} image={''} description={"Veplo è il sito dove trovare tutti i negozi di vestiti della tua città online"} />
