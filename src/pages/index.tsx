        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <div className="flex items-center justify-between border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
            ...
            <nav className="hidden space-x-10 md:flex">
              ...
              <Link href="/home/uomo" >
                <a className="text-base font-medium text-gray-500 hover:text-gray-900">Uomo</a>
                
              </Link>
              <Link href="/home/donna">
              <a className="text-base font-medium text-gray-500 hover:text-gray-900">Donna</a>
              </Link>
