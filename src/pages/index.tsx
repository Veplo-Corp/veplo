...
const Home: NextPage = () => {
  ...
  useEffect(() => {
    ...
    //   router.push('/abbigliamento/donna-tutto')
    // }
    // if (genderSelected === 'm') {
    //   router.push('/abbigliamento/uomo-tutto')
    // }
  }, [])
        ...
        <img className='hidden sm:flex absolute w-full z-10 object-cover h-screen'
          ...
          <div className='w-full'>
            ...
            >
              ...
              >
                VEPLO È UNA COMMUNITY CHE SELEZIONA I MIGLIORI MARCHI INDIPENDENTI E NEGOZI IN CIRCOLAZIONE.<br />SU VEPLO MIGLIAIA DI CLIENTI POSSONO TROVARE CAPI DI DESIGN E DI QUALITÀ, SVINCOLANDOSI DALLE INFLUENZE DEL FAST FASHION E TROVANDO COSÌ IL MODO DI ESPRIMERE LA LORO VERA IDENTITÀ.
              </Text>
              <div
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <Link
                      prefetch={false}
                      href="https://www.instagram.com/veplo_it/" target='_blank' className="text-[#666666] m-auto">
